 ...
 * @copyright  Copyright (c) 2007 NC State University Information Technology Division
 */
class Ot_Plugin_Auth extends Zend_Controller_Plugin_Abstract
{
    /**
     ...
     * @var unknown_type
     */
    private $_noAccount = array('module'     => 'account',
                                'controller' => 'index',
                                'action'     => 'edit');    
    ...
    public function dispatchLoopStartup(Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($auth->hasIdentity() && $config->loginOptions->requireAccountEntryOnLogin == 1) {
