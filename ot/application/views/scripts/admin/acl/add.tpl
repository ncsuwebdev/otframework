<div id="aclIndexAdd">
    {editable id="instructions"}Select the name that you would like to call the role.  This system also allows
    roles to inherit permission from an existing role.  Inheritance is optional
    but is useful in implementing a tiered access system.{/editable}<br /><br />
    ...
    <form method="post" id="aclEditor" action="{$sitePrefix}/admin/acl/{$action}" class="checkRequiredFields">
        ...
        <table class="form highlight">
            <tr>
                <td><b>{editable id=cautionLabel}CAUTION!{/editable}</b><br /><br />
