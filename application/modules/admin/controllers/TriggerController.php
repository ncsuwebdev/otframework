...
{	
    ...
    public function detailsAction()
    {
        ...
        foreach ($actions as &$a) {
        	$a['helper'] = $config->triggerHelpers->{$a['helper']};
        }
    ...
    public function addAction()
    {
        ...
        foreach ($config->triggerHelpers as $key => $value) {
        	$types[$key] = $value;
        }
    ...
    {       
        ...
        if (!isset($config->triggerHelpers->{$thisAction->helper})) {
        ...
        $helperStatic->setValue($config->triggerHelpers->{$thisAction->helper})
                    ->setAttrib('size', '40')
