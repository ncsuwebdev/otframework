...
{   
    ...
    {       
        ...
        $this->view
             ...
             ->appendStylesheet($this->view->baseUrl()
                . '/public/css/ot/jquery.plugin.tipsy.css');
        $this->view
             ->headScript()
             ->appendFile($this->view->baseUrl()
                . '/public/scripts/ot/jquery.plugin.tipsy.js');
    ...
    {       
        ...
        $reset = $form->createElement('checkbox', 'resetToDefault',
            array('label' => 'ot-config-edit:form:reset '));
        
        $submit = $form->createElement('submit', 'editButton',
            array('label' => 'ot-config-edit:form:submit'));
        ...
        if ($this->_request->isPost()) {
            if ($form->isValid($_POST)) {
                ...
                if ($form->getValue('resetToDefault')
                    ...
                    if ($form->getValue('resetToDefault')
                        && isset($xml->production->user->{$get->key})) {
                    ...
                    $this->_helper
                         ->log(Zend_Log::INFO, $logMessage, $logOptions);   
                ...
                $this->_helper
                     ...
                     ->addMessage($this->view
                                       ->translate('msg-info-configUpdated',
                                            $get->key));
