...
INSERT INTO `ot_tbl_ot_nav` VALUES(3, 2, 'Configuration', 'admin', 'index', 'index', '', '');
INSERT INTO `ot_tbl_ot_nav` VALUES(4, 3, 'App Config', 'admin', 'config', 'index', 'admin/config/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(5, 3, 'Debug Mode', 'admin', 'debug', 'index', 'admin/debug', '_self');
...
INSERT INTO `ot_tbl_ot_nav` VALUES(16, 2, 'Registered Applications', 'oauth', 'index', 'all-consumers', 'oauth/index/all-consumers', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(17, 2, 'Users', 'account', 'index', 'all', 'account/index/all', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(18, 2, 'User Access Roles', 'admin', 'acl', 'index', 'admin/acl/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(19, 2, 'Version Information', 'admin', 'index', 'index', 'admin/index/index', '_self');
...
INSERT INTO `ot_tbl_ot_role_rule` VALUES(8, 2, 'allow', '*', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(9, 3, 'allow', '*', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(111, 2, 'allow', '*', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(182, 1, 'allow', 'admin_bug', 'add', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(183, 1, 'allow', 'admin_bug', 'index', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(184, 1, 'allow', 'api_index', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(185, 1, 'allow', 'cron_index', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(186, 1, 'allow', 'default_index', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(187, 1, 'allow', 'error_error', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(188, 1, 'allow', 'image_index', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(189, 1, 'allow', 'login_index', '*', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(190, 1, 'allow', 'oauth_server', 'access-token', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(191, 1, 'allow', 'oauth_server', 'request-token', 'application');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(223, 1, 'deny', 'getVersions', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(224, 1, 'deny', 'getConfigOption', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(225, 1, 'deny', 'getMyAccount', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(226, 1, 'deny', 'updateMyAccount', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(227, 1, 'deny', 'getAccount', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(228, 1, 'deny', 'updateAccount', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(229, 1, 'deny', 'getCronJobs', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(230, 1, 'deny', 'setCronJobStatus', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(231, 1, 'deny', 'getBugReports', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(232, 1, 'allow', 'describe', '*', 'remote');
INSERT INTO `ot_tbl_ot_role_rule` VALUES(233, 3, 'allow', '*', '*', 'remote');
