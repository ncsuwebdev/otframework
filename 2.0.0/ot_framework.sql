...
INSERT INTO `ot_tbl_ot_nav` VALUES(3, 2, 'Configuration', 'admin', 'index', 'index', 'http://www.google.com', '_blank');
INSERT INTO `ot_tbl_ot_nav` VALUES(4, 3, 'App Config', 'admin', 'config', 'index', 'admin/config/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(5, 3, 'Maintenance Mode', 'admin', 'maintenance', 'index', 'admin/maintenance', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(6, 3, 'Navigation Editor', 'admin', 'nav', 'index', 'admin/nav/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(7, 2, 'App Triggers', 'admin', 'trigger', 'index', 'admin/trigger/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(8, 2, 'Bug Reports', 'admin', 'bug', '', 'admin/bug', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(9, 2, 'Caching', 'admin', 'cache', '', 'admin/cache', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(10, 2, 'Cron Jobs', 'admin', 'cron', 'index', 'admin/cron/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(11, 2, 'Custom Fields', 'admin', 'custom', 'index', 'admin/custom/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(12, 2, 'Database Backup', 'admin', 'backup', '', 'admin/backup', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(13, 2, 'Email Queue', 'admin', 'emailqueue', 'index', 'admin/emailqueue/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(14, 2, 'Logs', 'admin', 'log', 'index', 'admin/log/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(15, 2, 'Users', 'account', 'index', 'all', 'account/index/all', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(16, 2, 'User Access Roles', 'admin', 'acl', 'index', 'admin/acl/index', '_self');
INSERT INTO `ot_tbl_ot_nav` VALUES(17, 2, 'Version Information', 'admin', 'index', 'index', 'admin/index/index', '_self');
