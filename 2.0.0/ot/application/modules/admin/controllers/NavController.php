...
class Admin_NavController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_helper->pageTitle('Navigation Editor');;
        
        $this->view->siteUrl = Zend_Registry::get('siteUrl');
        $this->view->headScript()->appendFile($this->view->baseUrl() . '/public/ot/scripts/jquery.plugin.jtree.js')
                                 ->appendFile($this->view->baseUrl() . '/public/ot/scripts/jquery.plugin.json.js');
    ...
    public function saveAction()
    {
        ...
        if ($this->_request->isPost()) {
            ...
            try {
                ...
                $retData = array('rc' => '0', 'msg' => 'Error saving the navigation to the database: ' . $e->getMessage());
            ...
            $retData = array('rc' => '1', 'msg' => 'Navigation structure saved successfully to the database');
            echo Zend_Json_Encoder::encode($retData);
            return;
        }
    }
        ...
        if ($a['id'] != 0) {
            ...
            try {
                $this->_acl->get($a['module'] . "_" . $a['controller']);
                 ...
                 throw new Exception($a['module'] . '_' . $a['controller'] . ' is not a valid resource');
            }
