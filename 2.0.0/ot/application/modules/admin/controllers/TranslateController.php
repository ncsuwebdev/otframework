...
{       
    ...
    {    	    	         
    	...
    	if ($this->_request->isPost()) {
            ...
            if (!is_writable($path)) {
                $retData = array('rc' => '0', 'msg' => 'Langague override directory is not writable.');
			...
			foreach ($newData as $d) {
				...
				if ($ret === false) {
					$retData = array('rc' => '1', 'msg' => 'Error writing to language file.');
		            echo Zend_Json_Encoder::encode($retData);
		            return; 
				}
			}			
            ...
            $retData = array('rc' => '1', 'msg' => 'Text was successfully saved.');
            echo Zend_Json_Encoder::encode($retData);
            return;    		
