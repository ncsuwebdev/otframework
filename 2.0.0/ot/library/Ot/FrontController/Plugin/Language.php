...
class Ot_FrontController_Plugin_Language extends Zend_Controller_Plugin_Abstract
{
	...
	public function routeShutdown(Zend_Controller_Request_Abstract $request)
    {
		...
		$translate = new Zend_Translate($config->app->language->adapter, $config->app->language->directory, 'auto', $options);
		$translate->addTranslation('./ot/languages');
		$translate->addTranslation($config->app->overridePath . '/languages');
