...
class Ot_Oauth_Client 
{
    ...
    public function getAccessToken($params = array())
    {
        ...
        $req = Oauth_Request::fromConsumerAndToken($consumer, $this->_requestToken, 'GET', $this->_accessTokenUrl, $params);
     ...
     */
    public function sendApiRequest($uri, $requestMethod, $params = array())
    {                
        $this->_client->resetParameters();
        ...
        $this->_client->setMethod($requestMethod);
        ...
        $req = Oauth_Request::fromConsumerAndToken($consumer, $token, $requestMethod, $uri, $params);
        $req->signRequest($sigMethod, $consumer, $token);
